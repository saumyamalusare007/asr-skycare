...
import { fleetData, formatINR, operatorContacts } from "@/lib/data";
import { Users, Gauge, MapPin, ArrowRight, Check, Phone, MessageCircle, Stethoscope } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {fleetData.map((aircraft, index) => {
              const contact = operatorContacts[aircraft.operator];
              return (
                <motion.div
                  key={aircraft.id}
                  ...
                  <div className="p-5">
                    ...
                    {contact && (
                      <div className="flex gap-2 mb-4">
                        ...
                        <a href={`https://wa.me/${contact.whatsapp}`} target="_blank" rel="noopener noreferrer" className="flex-1">
                          <Button variant="outline" size="sm" className="w-full text-xs">

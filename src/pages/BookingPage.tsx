...
import { Heart, Activity, AlertTriangle, Baby, Skull, ArrowLeft, ArrowRight, Check, Plane, Ambulance, User, MapPin, Calendar, Phone, Mail, FileText } from "lucide-react";
import { serviceTypes, indianCities, type IndianCity } from "@/lib/data";
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bento-card lg:col-span-2 bg-aviation-red/5 border-aviation-red/20">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Our operations team will contact you with a custom quote based on your mission details. Proceed to confirm your booking request.
                      </p>
                    </div>
                  </div>
                </motion.div>

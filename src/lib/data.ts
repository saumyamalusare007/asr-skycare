...
export const serviceTypes: ServiceType[] = [
  ...
  {
    id: "mortuary-flight",
    title: "Dead Body Transportation (Mortuary Flight)",
    description: "Dignified repatriation and mortuary transport services",
    features: ["Embalming Support", "Documentation Assistance", "Door-to-Door"],

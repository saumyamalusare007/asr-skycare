...
import { Heart, Activity, AlertTriangle, Baby, Skull, ArrowRight, Check, Plane } from "lucide-react";
                  ...
                  <div className="bento-card h-full flex flex-col overflow-hidden p-0">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <div className="pt-4 border-t border-border">
                        <span className="text-sm font-medium text-aviation-red group-hover:underline">
                          Request Quote →
                        </span>
                      </div>
                    </div>

     ...
     <section className="relative min-h-screen flex items-center pt-16 lg:pt-20 overflow-hidden">
       ...
       <div className="container mx-auto px-4 relative z-10 py-20">
         <div className="max-w-4xl">
           ...
           >
             <Link to="/booking">
               <Button variant="aviation" size="xl" className="group">
                 Start Booking Now
                 <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
               </Button>
             </Link>
             <a href="tel:1800-ASR-HELP">
               <Button variant="aviation-outline" size="xl" className="text-white border-white hover:bg-white hover:text-primary">
